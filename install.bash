...
sudo docker build -t ntwuxc/jupyterhub .
...
sudo docker run -d --restart always -p 80:80 -p 443:8000 -p 222:22 -v /opt/JupyterHubDocker/persistent/:/persistent --net jupyterhubnet ntuwxc/jupyterhub bash runjupyterhub.bash
